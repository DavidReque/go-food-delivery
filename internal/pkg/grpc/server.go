...
import (
	...
	"github.com/DavidReque/go-food-delivery/internal/pkg/grpc/handlers/otel"
	"github.com/DavidReque/go-food-delivery/internal/pkg/grpc/interceptors"
...
func NewGrpcServer(
	...
	s := googleGrpc.NewServer(
		...
		googleGrpc.ChainStreamInterceptor(streamServerInterceptors...),
		googleGrpc.ChainUnaryInterceptor(unaryServerInterceptors...),
	)
