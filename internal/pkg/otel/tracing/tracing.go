...
// Implementa un sistema de trazado distribuido para monitorear y rastrear el flujo de
// las solicitudes a través de los diferentes servicios.
...
func (o *TracingOpenTelemetry) newResource() (*resource.Resource, error) {
	resource, err := resource.New(context.Background(),
		...
		resource.WithAttributes(
			...
			attribute.String("environment", o.env.GetEnvironmentName()),
