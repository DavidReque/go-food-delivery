...
import (
	...
	"github.com/DavidReque/go-food-delivery/internal/pkg/mongodb/repository"
	...
	data2 "github.com/DavidReque/go-food-delivery/internal/services/catalogreadservice/internal/products/contracts/data"
...
// NewMongoProductRepository create a new mongo product repository
func NewMongoProductRepository(
	...
	mongoRepo := repository.NewGenericMongoRepositoryWithDataModel[*models.Product, *models.Product](
		db,
