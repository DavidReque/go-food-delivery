...
import (
	...
	"github.com/DavidReque/go-food-delivery/internal/pkg/es/errors"
...
// NewEmptyAggregate initializes a new empty aggregate
...
// NewOrder initializes a new order aggregate
func NewOrder(
	id uuid.UUID,
	shopItems []*value_objects.ShopItem,
