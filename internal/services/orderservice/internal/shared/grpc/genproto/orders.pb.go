...
// ShopItem is a message that represents an item in the shop
...
// OrderReadModel is a message that represents an order in the database
...
// CreateOrderReq is a message that represents a request to create an order
