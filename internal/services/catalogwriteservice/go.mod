module github.com/DavidReque/go-food-delivery/internal/services/catalogwriteservice

go 1.24.2

require (
	emperror.dev/errors v0.8.1
	github.com/DavidReque/go-food-delivery/internal/pkg v0.0.0-20250816051418-a0394ef72c62
